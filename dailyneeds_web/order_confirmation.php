...
<!-- Basic Page Needs
================================================== -->
<title>DailyNeeds | Job Confirmation</title>
<meta charset="utf-8">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="order-confirmation-page">
				...
				<h2 class="margin-top-30">Thank you for your job!</h2>
				<p>Your payment has been processed successfully.</p>
				
				<?php if(isset($_SESSION['cc'])){?>
					<a href="<?php echo SITE_URL.'/order?cc='.base64_encode($_SESSION['cc']);?>" class="button ripple-effect-dark button-sliding-icon margin-top-30">View Job <i class="icon-material-outline-arrow-right-alt"></i></a>
				<?php }?>
